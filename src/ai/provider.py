...
is implementing this Protocol in a new class. Tests
inject `StubProvider`; production injects `DeepSeekProvider` (or Ollama).
"""
...
# Credential-shaped patterns that must NEVER appear in a prompt sent to an LLM (B7).
