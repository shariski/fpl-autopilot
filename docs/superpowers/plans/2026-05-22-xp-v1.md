...
- [x] **Step 1: Insert the concrete v1 subsection.** In `docs/decision-engine.md`, find this line (the heading that follows the existing xP v1 description):
...
- [x] **Step 2: Add a changelog row.** Find the FDR changelog row added previously:
...
- [x] **Step 1: Write the failing tests** in `tests/test_xp.py`
...
- [x] **Step 3: Write `src/analytics/xp.py`**
...
- [x] **Step 1: Write the failing test** — append to `tests/test_xp.py`
...
- [x] **Step 3: Append `upsert_xp` to `src/data/repository.py`**
...
- [x] **Step 1: Refresh, compute FDR, then xP, and eyeball the top of the table**
...
- [x] **Step 2: Confirm tests are the real DoD**
